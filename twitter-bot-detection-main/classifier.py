...
def train_model(classifier, feature_vector_train, label, feature_vector_valid, valid_y, epochs=1, show_report=True,
                print_pred=False):
...
features_with_class = ["name_contains_bot", "screen_name_contains_bot", "name_screen_levenshtein", "followers_count",
                       "following_count", "favorites_count", "tweets_count", "verified", "description_contains_link",
                       "description_contains_bot", "tweets_contains_link_count", "tweets_contains_bot_count",
                       "retweet_count", "tweet_levenstein1", "tweet_levenstein2", "tweet_levenstein3",
                       "tweet_levenstein4", "is_bot"]
features = ["name_contains_bot", "screen_name_contains_bot", "name_screen_levenshtein", "followers_count",
            "following_count", "favorites_count", "tweets_count", "verified", "description_contains_link",
            "description_contains_bot", "tweets_contains_link_count", "tweets_contains_bot_count", "retweet_count",
            "tweet_levenstein1", "tweet_levenstein2", "tweet_levenstein3", "tweet_levenstein4"]
...
model = ensemble.VotingClassifier(
    estimators=[('rf', model_random_forest), ('ada', model_ada_boost), ('hgb', model_hist_grad_boost)], voting='hard')
...
filename = "finalized_model92325.sav"
